...
import { Notification, Toast, Upload, Button,Table } from "../../../../components/ui";
...
const AttachmentDialog = () => {
  ...
  return (
    ...
    >
      ...
      <TBody>
          {poListData?.internal_inspection_check && <Tr>
            <Td style={style}>
Internal Inspection
            </Td>
            <Td style={style}>
          ...
          >
            <Button variant="" type="button" size="sm">
              ...
              {poListData?.material_tc_verify_check && <Tr>
            <Td style={style}>
Material TC
            </Td>
            <Td style={style}>
          ...
          >
            ...
            Upload
              ...
              {poListData?.ndt_requirement_check && <Tr>
            <Td style={style}>
NDT Requirement
            </Td>
            <Td style={style}>
          ...
          >
            ...
            Upload
              ...
              {poListData?.final_inspection_check && <Tr>
            <Td style={style}>
Final Inspection
            </Td>
            <Td style={style}>
          ...
          >
            ...
            Upload
              ...
              {poListData?.heat_treatment_check && <Tr>
            <Td style={style}>
Heat Treatment
            </Td>
            <Td style={style}>
