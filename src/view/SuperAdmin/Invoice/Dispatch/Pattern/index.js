...
import { apiGetDispatchPatterInvoiceByInvoiceId } from "../../../../../services/SuperAdmin/Invoice/DispatchServices";
import {
  Container,
  DoubleSidedImage,
  Loading,
...
const PatternInvoice = ({ pattern_invoice_id }) => {
  ...
  const fetchData = async () => {
    if (pattern_invoice_id) {
      setLoading(true);
      const response = await apiGetDispatchPatterInvoiceByInvoiceId({
        pattern_invoice_id,
      });
