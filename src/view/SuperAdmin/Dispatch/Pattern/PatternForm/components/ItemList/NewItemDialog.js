...
import { toggleAddDispatchItemDialog } from "../../../NewPattern/store/stateSlice";
...
const NewDispatchItemDialog = (props) => {
  ...
  const addDispatchItemDialog = useSelector(
    (state) => state.new_pattern_invoice.state.addDispatchItemDialog
  );
  ...
  return (
    <Dialog
      isOpen={addDispatchItemDialog.option}
