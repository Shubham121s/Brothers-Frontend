...
import { setSelectedBox, toggleEditBoxDialog } from '../../../NewDispatch/store/stateSlice'
...
const columns = [
    ...
    },
    {
        ...
        cell: (props) => {
            ...
            return (
                <ActionColumn row={original} index={index} />
            )
        },
    }
]
...
const BoxTable = (props) => {
    const { handleNewBoxAdd, className, values = [], setFieldValue } = props
