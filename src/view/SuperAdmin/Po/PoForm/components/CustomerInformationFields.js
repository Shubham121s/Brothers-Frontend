                ...
                {!isEmpty(values) ?
                    <div className='grid grid-cols-2 gap-2 mt-2 h-max'>
                        <Card bodyClass='p-4' className='bg-emerald-50'>
                            ...
                            <div className='flex justify-between capitalize'><strong>Type :</strong> <span>{values?.type || '-'}</span></div>
                            <div className='flex justify-between capitalize'><strong>Phone :</strong> <span>{values?.phone || '-'}</span></div>
                        </Card>
                        <Card bodyClass='p-4' className='bg-red-50'>
                            <div className='flex justify-between'><strong>Email :</strong> <span className='lowerCase'>{values?.email || '-'}</span></div>
