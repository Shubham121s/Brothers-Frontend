export const InvoiceTitle = ({
  ...
  worksheet.getCell(`A${PageStart}`).value = Title
...
export const InvoiceNumber = ({ worksheet, PageStart = 1 }) => {
...
export const InvoiceDate = ({ worksheet, PageStart = 1 }) => {
...
export const BuyerOrderDetails = ({ worksheet, data, PageStart = 1 }) => {
  ...
  data.orderNumbers.forEach((order, index) => {
    if (index < arr.length) {
...
export const ConsigneeDetails = ({ worksheet, data, PageStart = 1 }) => {
...
export const BuyerDetails = ({ worksheet, data, PageStart = 1 }) => {
...
export const GSTandOtherDetails = ({ worksheet, data, PageStart = 1 }) => {
...
export const PortDetails = ({ worksheet, data, PageStart = 1 }) => {
...
export const DestinationDetails = ({ worksheet, data, PageStart = 1 }) => {
...
export const BoxDetails = ({ worksheet, data, PageStart = 1 }) => {
