...
const generateInvoiceExcel = (invoiceData) => {
  ...
  // Add the image to the worksheet in cell A1
  worksheet.addImage(imageId, {
    tl: { col: 0, row: 0 },   // Top-left position (A1 is col 0, row 0)
    ext: { width: 100, height: 50 } , // Set width and height of the image
    offset: { x: 200,y:100 }
  });
  // for (let row = 1; row <= 15; row++) {
  //   worksheet.getCell(`J${row}`).border = {
  //     right: { style: 'medium' }  // Add a thin left border to each cell
  //   };
  // }
...
//   let columns = ['B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'];

// columns.forEach((col) => {
//   worksheet.getCell(`${col}1`).border = {
//     bottom: { style: 'medium' }  // Add a medium bottom border to each cell
//   };
...
//     const cell = worksheet.getRow(row);
...
worksheet.getCell(`A1`).border = {
  right: { style: 'medium' },
bottom: { style: 'medium' }  // Add a thin left border to each cell
};
...
const invoiceData = {
  ...
  orderNumbers: ['EO2023120118', 'EO2024010049-36','EO2023120118', 'EO2024010049-36','EO2023120118', 'EO2024010049-36','EO2023120118', 'EO2024010049-36','EO2023120118', 'EO2024010049-36','EO2023120118', 'EO2024010049-36','EO2023120118', 'EO2024010049-36','EO2023120118', 'EO2024010049-36','EO2023120118', 'EO2024010049-36','EO2023120118', 'EO2024010049-36','EO2023120118', 'EO2024010049-36','EO2023120118', 'EO2024010049-36','EO2023120118', 'EO2024010049-36'],
  consigneeName: 'HYOSUNG GOODSPRINGS',
  consigneeAddress: '431, UNGNAMDONG, SEONGSANGU, CHANGWONSI, GYEONGSANGNAMDO, KOREA, 51559',
...
},
{
  ...
  totalQty: 4,
  totalAmount: 183098.50,
  amountInWords: 'ONE HUNDRED EIGHTY THREE THOUSAND NINETY EIGHT DOLLAR AND FIFTY CENTS ONLY',
  noOfBox: 1,
  netWeight: '56.000 Kg',
